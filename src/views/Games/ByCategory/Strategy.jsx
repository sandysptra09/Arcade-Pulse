...
export default function Strategy() {
    ...
    const [randomStrategyData, setRandomStrategyData] = useState(null);

    useEffect(() => {
        const fetchBrowseStrategy = async () => {
            try {
                ...
                setStrategy(response.data.slice(0, 70));

                const randomDataStrategy = getRandomDataStrategy(response.data, 3);
                setRandomStrategyData(randomDataStrategy)
        ...
        const getRandomDataStrategy = (data, count) => {
            ...
            <div className="py-8 px-16 mx-auto max-w-screen-xl lg:py-16">
                <div>
                    <h1 className="text-3xl text-gray-300 font-medium mb-4">
                        Top Free Strategy Games for Browser In 2024!
                    </h1>
                    <p className="text-gray-400 text-sm mb-6">
                        Tactical planning and leadership in battles
                    </p>
                    <div className='mb-12'>
                        <div className="grid md:grid-cols-3 gap-6 mb-6">
                            {randomStrategyData &&
                                randomStrategyData.map((randomData) => (
