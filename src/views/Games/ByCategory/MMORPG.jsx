...
export default function MMORPG() {
    const [mmorpg, setMMORPG] = useState(null);
    const [randomMMORPGData, setRandomMMORPGData] = useState(null);
    ...
    useEffect(() => {
        const fetchBrowseMMORPG = async () => {
            try {
                ...
                setMMORPG(response.data.slice(0, 70));

                const randomDataMMORPG = getRandomDataMMORPG(response.data, 3);
                setRandomMMORPGData(randomDataMMORPG)
        ...
        const getRandomDataMMORPG = (data, count) => {
            ...
            <div className="py-8 px-16 mx-auto max-w-screen-xl lg:py-16">
                <div>
                    ...
                    <p className="text-gray-400 text-sm mb-6">
                        Online adventure in a vast open world
                    </p>
                    <div className='mb-12'>
                        <div className="grid md:grid-cols-3 gap-6 mb-6">
                            {randomMMORPGData &&
                                randomMMORPGData.map((randomData) => (
