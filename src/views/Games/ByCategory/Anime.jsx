    ...
    useEffect(() => {
        const fetchBrowseAnime = async () => {
            try {
                ...
                setAnime(response.data.slice(0, 70));

                const randomDataAnime = getRandomDataAnime(response.data, 3);
                setRandomAnimeData(randomDataAnime)
        ...
        const getRandomDataAnime = (data, count) => {
            ...
            <div className="py-8 px-16 mx-auto max-w-screen-xl lg:py-16">
                <div>
                    <h1 className="text-3xl text-gray-300 font-medium mb-4">
                        Top Free Anime Games for Browser In 2024!
                    </h1>
                    <p className="text-gray-400 text-sm mb-6">
                        Stylish Japanese animation visuals and storytelling
                    </p>
                    <div className='mb-12'>
                        <div className="grid md:grid-cols-3 gap-6 mb-6">
                            {randomAnimeData &&
                                randomAnimeData.map((randomData) => (
