...
export default function Shooter() {
    ...
    const [randomDataShooter, setRandomDataShooter] = useState(null);

    useEffect(() => {
        const fetchBrowseMMORPG = async () => {
            try {
                ...
                setShooter(response.data.slice(0, 70));

                const randomDataMMORPG = getRandomDataShooter(response.data, 3);
                setRandomDataShooter(randomDataMMORPG)
        ...
        const getRandomDataShooter = (data, count) => {
            ...
            <div className="py-8 px-16 mx-auto max-w-screen-xl lg:py-16">
                <div>
                    <h1 className="text-3xl text-gray-300 font-medium mb-4">
                        Top Free Shooter Games for Browser In 2024!
                    </h1>
                    <p className="text-gray-400 text-sm mb-6">
                        Intense online shooting action and strategy
                    </p>
                    <div className='mb-12'>
                        <div className="grid md:grid-cols-3 gap-6 mb-6">
                            {randomDataShooter &&
                                randomDataShooter.map((randomData) => (
